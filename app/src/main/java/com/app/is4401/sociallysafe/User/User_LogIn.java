...
//                        //redirect to profile
//                        startActivity(new Intent(User_LogIn.this, UserActivity.class));
//                        Toast.makeText(User_LogIn.this, "Signing In", Toast.LENGTH_LONG).show();
//                    } else{
...
//
//                }else{
//                    Toast.makeText(User_LogIn.this, "Login failed! Please check your credentials.", Toast.LENGTH_LONG).show();
//                }
//            }
//        });
//    }
